...
class Listing extends ApiClient {
	...
	public function search($keyword, $maxPrice, $minPrice, $includeResidential, $includeLand, $includeCommercial) {
		$postData = array('Keyword' => $keyword,
						  ...
						  'IncludeResidential' => (boolean)($includeResidential),
						  'IncludeLand' => (boolean)($includeLand),
						  'IncludeCommercial' => (boolean)($includeCommercial));
	...
	public function imageUrl($listingSource, $listingType, $listingId, $photoId = 0, $width = null, $height = null) {
